...
const DEMO = [
  {id:"R1",patient:"IQ-0042",diagnosis:"Malignant",noise:"5%", psnr:34.76,ssim:1.000,mse:26.46, snr:18.69,noise_sigma:0.05},
  {id:"R2",patient:"IQ-0087",diagnosis:"Normal",   noise:"10%",psnr:31.68,ssim:1.000,mse:70.99, snr:15.46,noise_sigma:0.10},
  {id:"R3",patient:"IQ-0134",diagnosis:"Benign",   noise:"15%",psnr:29.23,ssim:1.000,mse:101.35,snr:15.09,noise_sigma:0.15},
  {id:"R4",patient:"IQ-0221",diagnosis:"Malignant",noise:"20%",psnr:25.92,ssim:0.997,mse:135.65,snr:9.80, noise_sigma:0.20},
  {id:"R5",patient:"IQ-0310",diagnosis:"Benign",   noise:"25%",psnr:21.49,ssim:0.980,mse:156.90,snr:6.90, noise_sigma:0.25},
  {id:"R6",patient:"IQ-0455",diagnosis:"Normal",   noise:"30%",psnr:27.64,ssim:0.999,mse:206.91,snr:5.11, noise_sigma:0.30},
];
...
function CTCanvas({ id, noisePct=0, variant="original", w=220, h=220 }) {
  ...
  useEffect(() => {
    ...
    const rings=[{rx:.44,ry:.38,v:38},{rx:.33,ry:.29,v:62},{rx:.23,ry:.21,v:90},
                 {rx:.15,ry:.13,v:132},{rx:.09,ry:.08,v:186},{rx:.05,ry:.04,v:210}];
  ...
  return <canvas ref={ref} id={id} width={w} height={h} className="w-full h-full object-cover" />;
}
...
export default function RadiologistView() {
  ...
  const { data: images=[] } = useQuery("images", ()=>apiListImages(20).then(r=>r.data), {placeholderData:[]});
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card p-3 flex items-center justify-between flex-wrap gap-3">
        ...
        <button className="btn btn-sm" style={{ color:T, borderColor:"var(--c-border2)" }}
        ...
        <div className="lg:col-span-2 space-y-3">
          ...
          <div className="card p-2.5 flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <input type="range" min="50" max="200" value={brightness}
                ...
                className="w-20" style={{ accentColor:A }} title="Brightness"/>
            ...
            <div className="flex items-center gap-2">
              ...
              <input type="range" min="50" max="250" value={contrast}
                ...
                className="w-20" style={{ accentColor:T }} title="Contrast"/>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={variant} className="card overflow-hidden border-2"
                style={{ borderColor }}>
                <div style={{
                ...
                <div className="text-[11px] text-center py-1.5 font-medium"
                  style={{
